...
const FolioHoverCard = () => {
  return (
    <div className="size-full p-2 -translate-x-16  opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 absolute top-0  bg-[#ffb300b2] flex flex-col items-center justify-center gap-7">
      <div className="bg-[#ffffffe0] cursor-pointer rounded-full flex items-center justify-center size-[65px]">
      ...
      <div className="bg-[#ffffffe0] rounded-full flex items-center justify-center size-[65px]">
        <FaGithub className="text-4xl cursor-pointer text-gray-700" />
      </div>
    </div>
  );
};
